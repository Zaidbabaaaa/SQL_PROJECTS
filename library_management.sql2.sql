...
-- Objective: Use GROUP BY to find members who have issued more than one book.
	...
	select issued_member_id,count(issued_book_name)as total_count
	from issued_status
...
--Used CTAS to generate new tables based on query results - each book and total book_issued_cnt**
	...
	create table book_counts as
		select issued_book_name,count(issued_book_name)as total_count
		from issued_status
...
-- Task 8: Find Total Rental Income by Category:--
	...
	from books as b
	join issued_status as i_st
	on b.isbn=i_st.issued_book_isbn
	group by category;
...
--Task 10: List Employees with Their Branch Manager's Name and their branch details:--
	...
	select employees.emp_name,branch.manager_id,branch.branch_address,branch.branch_id
